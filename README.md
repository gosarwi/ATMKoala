...
The static libc smoke application covers CRT startup, allocation, musl-derived string and ctype functions, integer parsing, binary search, GUI ABI checks, `fstat`, and native socket lifecycle operations.
